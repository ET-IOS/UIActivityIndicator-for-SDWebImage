Pod::Spec.new do |s|
  ...
  s.homepage      = "https://github.com/ET-IOS/UIActivityIndicator-for-SDWebImage"
  s.license       = { :type => 'MIT License', :file => 'LICENSE.txt' }
  s.author        = { "Giacomo Saccardo" => "gsaccardo@gmail.com" }
  s.source        = { :git => "https://github.com/ET-IOS/UIActivityIndicator-for-SDWebImage.git", :tag => "1.3" }
  s.platform      = :ios, '5.0'
  s.source_files  = '*.{h,m}'
  s.requires_arc  = true
